...
'''
Module
    general_config_test_mode_test.py
Copyright
...
Info
    Defines class GenConfigTestTestCase with attribute(s) and method(s).
    Creates test cases for checking functionalities of general configuration.
Execute
    python3 -m unittest -v general_config_test_mode_test
'''
...
class GenConfigTestTestCase(unittest.TestCase):
    '''
        Defines class GenConfigTestTestCase with attribute(s) and method(s).
    ...
    def setUp(self) -> None:
        ...
        self.debug_cfg: bool | None = TestConfig.DEBUG
        self.wtf_csrf_enabled: bool | None = TestConfig.WTF_CSRF_ENABLED
        self.debug_tb_enabled: bool | None = TestConfig.DEBUG_TB_ENABLED
        self.debug_tbir: bool | None = TestConfig.DEBUG_TB_INTERCEPT_REDIRECTS
        self.bcrypt_log_rounds: int | None = TestConfig.BCRYPT_LOG_ROUNDS
    ...
    def test_debug_tbir(self) -> None:
        ...
        self.assertEqual(self.debug_tbir, True)
