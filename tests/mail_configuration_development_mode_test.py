...
'''
 Module
     mail_configuration_development_mode_test.py
 Copyright
 ...
 Info
     Defined class MailDevelopmentTestCase with attribute(s) and method(s).
     Created test cases for checking functionalities of mail configuration.
 Execute
     python3 -m unittest -v mail_configuration_development_mode_test
'''
...
try:
    from app_server.configuration.mail.development_config import DevelopmentConfig
...
class MailDevelopmentTestCase(unittest.TestCase):
    '''
        Defined class MailDevelopmentTestCase with attribute(s) and method(s).
        Created test cases for checking functionalities of mail configuration.
        It defines:
    ...
    def setUp(self):
        ...
        self.mail_use_ssl = DevelopmentConfig.MAIL_USE_SSL
        self.mail_username = DevelopmentConfig.MAIL_USERNAME
