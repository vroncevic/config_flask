...
'''
 Module
     general_configuration_production_mode_test.py
 Copyright
 ...
 Info
     Defined class GeneralConfigProductionTestCase with attribute(s) and method(s).
     Created test cases for checking functionalities of general configuration.
 Execute
     python3 -m unittest -v general_configuration_production_mode_test
'''
...
try:
    from app_server.configuration.production_config import ProductionConfig
...
class GeneralConfigProductionTestCase(unittest.TestCase):
    '''
        Defined class GeneralConfigProductionTestCase with attribute(s) and method(s).
    ...
    def setUp(self) -> None:
        ...
        self.debug = ProductionConfig.DEBUG
        self.wtf_csrf_enabled = ProductionConfig.WTF_CSRF_ENABLED
        self.debug_tb_enabled = ProductionConfig.DEBUG_TB_ENABLED
        self.debug_tb_intercept_redirects = ProductionConfig.DEBUG_TB_INTERCEPT_REDIRECTS
        self.bcrypt_log_rounds = ProductionConfig.BCRYPT_LOG_ROUNDS
    ...
    def test_debug_tb_intercept_redirects(self) -> None:
        ...
        self.assertEqual(self.debug_tb_intercept_redirects, False)
