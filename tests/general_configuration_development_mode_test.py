...
'''
 Module
     general_configuration_development_mode_test.py
 Copyright
 ...
 Info
     Defined class GeneralConfigDevelopmentTestCase with attribute(s) and method(s).
     Created test cases for checking functionalities of general configuration.
 Execute
     python3 -m unittest -v general_configuration_development_mode_test
'''
...
class GeneralConfigDevelopmentTestCase(unittest.TestCase):
    '''
        Defined class GeneralConfigDevelopmentTestCase with attribute(s) and method(s).
    ...
    def setUp(self):
        ...
        self.debug = DevelopmentConfig.DEBUG
        self.wtf_csrf_enabled = DevelopmentConfig.WTF_CSRF_ENABLED
        self.debug_tb_enabled = DevelopmentConfig.DEBUG_TB_ENABLED
        self.debug_tb_intercept_redirects = DevelopmentConfig.DEBUG_TB_INTERCEPT_REDIRECTS
        self.bcrypt_log_rounds = DevelopmentConfig.BCRYPT_LOG_ROUNDS
