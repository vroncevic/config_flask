...
Info
    Defines class MailProdTestCase with attribute(s) and method(s).
    Creates test cases for checking functionalities of mail configuration.
Execute
    python3 -m unittest -v mail_config_prod_mode_test
'''
...
try:
    from app_server.configuration.mail.prod_config import ProdConfig
...
class MailProdTestCase(unittest.TestCase):
    '''
        Defines class MailProdTestCase with attribute(s) and method(s).
    ...
    def setUp(self) -> None:
        ...
        self.mail_server: str | None = ProdConfig.MAIL_SERVER
        self.mail_port: int | None = ProdConfig.MAIL_PORT
        self.mail_use_ssl: bool | None = ProdConfig.MAIL_USE_SSL
        self.mail_username: str | None = ProdConfig.MAIL_USERNAME
        self.mail_password: str | None = ProdConfig.MAIL_PASSWORD
        self.mail_recipient: str | None = ProdConfig.MAIL_RECIPIENT
